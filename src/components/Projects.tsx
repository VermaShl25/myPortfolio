      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div 
              key={index}
              className={`group bg-gradient-to-br from-slate-800/80 to-slate-900/80 rounded-2xl overflow-hidden border border-slate-700/50 backdrop-blur-sm hover:border-cyan-400/50 transition-all duration-500 transform hover:-translate-y-4 hover:shadow-2xl hover:shadow-cyan-400/20 animate-fade-in ${project.featured ? 'lg:col-span-1 md:col-span-2' : ''}`}
            ...
            >
              ...
              <div className="relative overflow-hidden h-48">
                ...
                <div className="absolute top-4 left-4">
                  <span className={`px-3 py-1 rounded-full text-xs font-semibold text-white bg-gradient-to-r ${getStatusColor(project.status)} shadow-lg backdrop-blur-sm`}>
                    {project.status}
                  </span>
                </div>
              ...
              <div className="p-8">
                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-cyan-400 transition-colors duration-300 flex items-center">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.technologies.map((tech, techIndex) => (
                    <span 
                      key={techIndex}
                      className="px-3 py-1 bg-gradient-to-r from-cyan-400/20 to-blue-400/20 text-cyan-400 rounded-full text-xs font-medium border border-cyan-400/30 hover:from-cyan-400/30 hover:to-blue-400/30 hover:scale-105 transition-all duration-300 cursor-default hover:shadow-lg hover:shadow-cyan-400/25"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="flex gap-3">
                  <Button 
                    size="sm" 
                    className="bg-gradient-to-r from-cyan-400 to-cyan-500 hover:from-cyan-500 hover:to-cyan-600 text-slate-900 flex-1 font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-cyan-400/25"
              ...
              {/* Hover Glow Effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-cyan-400/5 via-transparent to-blue-500/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
            </div>
          ))}
        </div>
        ...
        <div className="text-center mt-16 animate-fade-in delay-600">
          <div className="bg-gradient-to-r from-slate-900/80 to-slate-800/80 rounded-2xl p-8 border border-slate-700/50 backdrop-blur-sm hover:border-cyan-400/50 transition-all duration-500 group">
            ...
            <Button 
              className="bg-gradient-to-r from-cyan-400 to-blue-500 hover:from-cyan-500 hover:to-blue-600 text-white font-semibold px-8 py-3 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-cyan-400/25"
